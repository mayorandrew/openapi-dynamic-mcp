...
const API_NAME = 'slack';
const SPEC_FILE = 'slack.yaml';
const DETAIL_ENDPOINT_ID = 'admin_apps_approve';
const REQUEST_ENDPOINT_ID = 'admin_conversations_restrictAccess_addGroup';
