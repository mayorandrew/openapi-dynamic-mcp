...
const API_NAME = 'sendgrid';
const SPEC_FILE = 'sendgrid.yaml';
const DETAIL_ENDPOINT_ID = 'GET_access_settings-activity';
const REQUEST_ENDPOINT_ID = 'GET_access_settings-activity';
