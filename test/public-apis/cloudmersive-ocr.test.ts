...
const API_NAME = 'cloudmersive-ocr';
const SPEC_FILE = 'cloudmersive-ocr.yaml';
const DETAIL_ENDPOINT_ID = 'ImageOcr_ImageLinesWithLocation';
const REQUEST_ENDPOINT_ID = 'ImageOcr_ImageLinesWithLocation';
beforeEach(async () => {
