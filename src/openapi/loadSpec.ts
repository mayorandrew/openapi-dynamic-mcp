...
import type { ApiConfig, ApiRegistry, LoadedApi, RootConfig } from "../types.js";
...
async function loadSingleApi(api: ApiConfig, env: NodeJS.ProcessEnv): Promise<LoadedApi> {
  let parsed: unknown;
  try {
